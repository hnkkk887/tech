      ...
      <Container>
        <Row className="align-items-center">
          ...
          <Col lg={6}>
            ...
            <p>
              Welcome to our Spanish-based e-commerce store! We offer a wide range of electronics at competitive prices, and we ship our products throughout USA. We strive to provide our customers with the best possible shopping experience, which is why we accept ETH as a payment option.
            </p>
            <p>
              At our store, we understand the importance of reliable and efficient shipping, which is why we have partnered with trusted shipping providers(DHL, UPS, FedEx), to ensure that your orders are delivered promptly and safely.
            </p>            
            <p>
