...
const Checkout = () => {
  ...
  async function ethTransform() {
    let p = getDiscountPrice(cartTotalPrice, 10);
  ...
  return (
    <LayoutOne>
      ...
      {accountID ? null : <Button variant="dark" style={{display: "block", margin: "0 auto", marginBottom: "10px"}} onClick={connectMetamask}>Connect Metamask</Button>}
                    ...
                    <div className="payment-option space-mb--20">
                      {/* <div className=" space-mb--20">
                        ...
                        <p data-method="option3" className="payment-text">
                          Bank transfers are available on orders over $ 300. After you’ve placed your order, we will send you an email with the payment informations. If we do not receive your payment within 10 days, your order will be canceled {" "}
                        </p>
                      </div> */}
